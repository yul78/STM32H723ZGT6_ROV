...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, DIR1OUT_Pin|DIR2OUT_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, EN2OUT_Pin|OLED_SCL_Pin|OLED_SDA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR1OUT_Pin DIR2OUT_Pin */
  GPIO_InitStruct.Pin = DIR1OUT_Pin|DIR2OUT_Pin;
